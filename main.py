...
from endpoints import get_balance, get_utxos, get_blocks, get_blockdag, get_circulating_supply, get_coinsecd_info, \
...
from endpoints.coinsecd_requests.submit_transaction_request import submit_a_new_transaction
from helper import get_sec_market_data
...
print(
    ...
    f"{get_coinsecd_info}, {get_network}, {get_marketcap}, {get_hashrate}, {get_blockreward}"
