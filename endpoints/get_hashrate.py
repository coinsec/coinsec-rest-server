...
@app.get("/info/hashrate", response_model=HashrateResponse | str, tags=["Coinsec network info"])
...
@app.get("/info/hashrate/max", response_model=MaxHashrateResponse, tags=["Coinsec network info"])
@sql_db_only
