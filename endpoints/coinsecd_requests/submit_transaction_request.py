...
async def submit_a_new_transaction(body: SubmitTransactionRequest):
    """
    Forwards the body directly to coinsecd with the command submitTransactionRequest
    """
    tx_resp = await coinsecd_client.request("submitTransactionRequest",
                                          params=body.dict())
