...
@app.get("/info/get-vscp-from-block", response_model=VscpResponse, tags=["Coinsec network info"])
async def get_virtual_selected_parent_chain_from_block(
    ...
    some startHash to this coinsecd's current virtual.
    """
    resp = await coinsecd_client.request("getVirtualSelectedParentChainFromBlockRequest",
                                       params={
                                           "startHash": startHash,
